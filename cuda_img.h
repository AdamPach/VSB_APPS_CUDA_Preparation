...
struct CudaImg
{
  ...
  __device__ uchar1 & at1( int x, int y ) { return m_p_uchar1[ y * m_size.x + x ]; }
  __device__ uchar3 & at3( int x, int y ) { return m_p_uchar3[ y * m_size.x + x ]; }
  __device__ uchar4 & at4( int x, int y ) { return m_p_uchar4[ y * m_size.x + x ]; }
};
